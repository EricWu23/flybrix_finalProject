...
#define AVERAGE_DELAY_TARGET_USEC 3000 //1400
...
void loop() {
	...
	if (sys.state.getAhrsType() == Ahrs::Type::UAV_Class && sys.flag.is(Status::ARMED)) {
		sys.led.errorStart(LEDPattern::SOLID, CRGB::Blue, CRGB::Red, 2);
		//return;
	}
